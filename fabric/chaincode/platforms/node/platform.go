...
import (
	...
	"compress/gzip"
	"errors"
	flogging "fabric-sdk-go/common/logger"
...
func (p *Platform) NormalizePath(path string) (string, error) {
	return "", nil
}

// ValidatePath ValidateSpec validates Go chaincodes
...
// GetDeploymentPayload Generates a deployment payload by putting source files in src/$file entries in .tar.gz format
