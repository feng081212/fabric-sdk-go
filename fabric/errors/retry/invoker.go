...
// NewInvokerWithRetryOpts creates a new RetryableInvoker
func NewInvokerWithRetryOpts(retryOpts Opts, opts ...InvokerOpt) *RetryableInvoker {
	return NewInvoker(New(retryOpts), opts...)
}
...
func RetryableInvoke(retryOpts Opts, invocation Invocation) (interface{}, error) {
	return NewInvokerWithRetryOpts(retryOpts).Invoke(invocation)
}
