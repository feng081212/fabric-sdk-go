...
func hasLoggerFnPrefix(pkgPath string, fnName string) bool {
	const (
		loggingAPIPath = "fabric-sdk/pkg/core/logging/"
		loggingAPIPkg  = "api" // Go < 1.12
		modlogFnPrefix = "modlog.(*Log)."
		loggingPath    = "fabric-sdk/pkg/common/"
		loggingPkg     = "logging"
		logBridgePath  = "fabric-sdk/internal/github.com/hyperledger/fabric-ca/sdkpatch/logbridge"
